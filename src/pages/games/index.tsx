...
import DialogEditGame from "./dialog-edit";
import DialogCreateGame from "./dialog-create-game";
import DialogViewGame from "./dialog-view";
import TableGameGenericCell from "@/components/pages/games/game-cell";
import DialogCreatePrize from "./dialog-create-prize-game";
import DialogCreatePrizeLottery from "./dialog-create-prize-lottery";
